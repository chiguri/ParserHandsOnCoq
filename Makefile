...
VFILES:=AbstractParser.v\
  ...
  MyRegularExpressionParser.v\
  MyJSONParser.v\
  MyDigitParserTest.v\
  MyIntegerParserTest.v\
  MyLimitedExpressionParserTest.v\
  MyExpressionParserTest.v\
  MyRegularExpressionParserTest.v\
  MyJSONParserTest.v\
  Answer/MyDigitParser.v\
  Answer/MyIntegerParser.v\
  Answer/MyLimitedExpressionParser.v\
  Answer/MyExpressionParser.v\
  Answer/MyRegularExpressionParser.v\
  Answer/MyJSONParser.v
